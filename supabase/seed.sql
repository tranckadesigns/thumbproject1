...
insert into public.assets
  (slug, title, short_description, full_description, category, style_type, thumbnail_url, preview_images, psd_file_key, file_size_mb, version, is_featured, is_published, tags, created_at)
values
...
(
  ...
  'Revenue', 'Dark', '', '{}', 'revenue/youtube-revenue-alert.psd',
  18.4, '1.0', true, true,
...
(
  ...
  'Revenue', 'Dark', '', '{}', 'revenue/stripe-payout-notification.psd',
  14.2, '1.0', false, true,
...
(
  ...
  'Revenue', 'Dark', '', '{}', 'revenue/adsense-revenue-card.psd',
  16.1, '1.0', false, true,
...
(
  ...
  'Revenue', 'Dark', '', '{}', 'revenue/paypal-payout-badge.psd',
  11.8, '1.0', false, true,
...
(
  ...
  'Subscribers', 'Bold', '', '{}', 'subscribers/100k-subscriber-milestone.psd',
  22.1, '1.0', true, true,
...
(
  ...
  'Subscribers', 'Minimal', '', '{}', 'subscribers/subscriber-count-ticker.psd',
  11.8, '1.0', false, true,
...
(
  ...
  'Subscribers', 'Bold', '', '{}', 'subscribers/1m-subscriber-badge.psd',
  24.7, '1.0', true, true,
...
(
  ...
  'Subscribers', 'Minimal', '', '{}', 'subscribers/weekly-subscriber-gain.psd',
  9.4, '1.0', false, true,
...
(
  ...
  'Growth', 'Dark', '', '{}', 'growth/viral-growth-chart.psd',
  16.5, '1.0', true, true,
...
(
  ...
  'Growth', 'Bold', '', '{}', 'growth/views-milestone-popup.psd',
  14.2, '1.0', false, true,
...
(
  ...
  'Growth', 'Dark', '', '{}', 'growth/channel-performance-card.psd',
  12.8, '1.0', false, true,
...
(
  ...
  'Alerts', 'Dark', '', '{}', 'alerts/real-time-alert-banner.psd',
  9.3, '1.0', false, true,
...
(
  ...
  'Alerts', 'Bold', '', '{}', 'alerts/breaking-update-banner.psd',
  8.7, '1.0', false, true,
...
(
  ...
  'Alerts', 'Minimal', '', '{}', 'alerts/important-notification-card.psd',
  10.2, '1.0', false, true,
...
(
  ...
  'Social', 'Dark', '', '{}', 'social/instagram-follower-spike.psd',
  12.7, '1.0', false, true,
...
(
  ...
  'Social', 'Dark', '', '{}', 'social/twitter-viral-card.psd',
  11.3, '1.0', false, true,
...
(
  ...
  'Social', 'Bold', '', '{}', 'social/tiktok-fyp-badge.psd',
  10.5, '1.0', false, true,
...
(
  ...
  'E-Commerce', 'Dark', '', '{}', 'commerce/shopify-sales-dashboard.psd',
  19.8, '1.0', true, true,
...
(
  ...
  'E-Commerce', 'Minimal', '', '{}', 'commerce/digital-product-sale-badge.psd',
  9.6, '1.0', false, true,
...
(
  ...
  'E-Commerce', 'Dark', '', '{}', 'commerce/course-enrollment-counter.psd',
  13.1, '1.0', false, true,
...
(
  ...
  'Analytics', 'Dark', '', '{}', 'analytics/ctr-analytics-display.psd',
  15.1, '1.0', false, true,
...
(
  ...
  'Analytics', 'Dark', '', '{}', 'analytics/watch-time-dashboard.psd',
  14.7, '1.0', false, true,
...
(
  ...
  'Analytics', 'Minimal', '', '{}', 'analytics/impressions-analytics-card.psd',
  12.3, '1.0', false, true,
...
(
  ...
  'Challenges', 'Bold', '', '{}', 'challenges/30-day-challenge-progress.psd',
  10.6, '1.0', false, true,
...
(
  ...
  'Challenges', 'Bold', '', '{}', 'challenges/100-day-challenge-tracker.psd',
  11.9, '1.0', false, true,
...
(
  ...
  'Challenges', 'Bold', '', '{}', 'challenges/weekly-streak-badge.psd',
  8.4, '1.0', false, true,
...
(
  ...
  'Comparisons', 'Bold', '', '{}', 'comparisons/best-vs-worst-comparison.psd',
  13.4, '1.0', true, true,
...
(
  ...
  'Comparisons', 'Minimal', '', '{}', 'comparisons/before-after-reveal.psd',
  11.2, '1.0', false, true,
...
(
  ...
  'Comparisons', 'Dark', '', '{}', 'comparisons/old-vs-new-comparison.psd',
  12.6, '1.0', false, true,
...
(
  ...
  'Ratings', 'Minimal', '', '{}', 'ratings/five-star-rating-display.psd',
  8.9, '1.0', false, true,
...
(
  ...
  'Ratings', 'Bold', '', '{}', 'ratings/product-score-badge.psd',
  7.8, '1.0', false, true,
...
(
  ...
  'Ratings', 'Dark', '', '{}', 'ratings/app-store-rating-card.psd',
  13.5, '1.0', false, true,
...
(
  ...
  'Timers', 'Bold', '', '{}', 'timers/launch-countdown-timer.psd',
  12.3, '1.0', false, true,
...
(
  ...
  'Timers', 'Bold', '', '{}', 'timers/live-event-countdown.psd',
  10.8, '1.0', false, true,
...
(
  ...
  'Timers', 'Dark', '', '{}', 'timers/stream-golive-timer.psd',
  9.1, '1.0', false, true,
...
(
  ...
  'Reactions', 'Dark', '', '{}', 'reactions/poll-result-overlay.psd',
  10.1, '1.0', false, true,
...
(
  ...
  'Reactions', 'Bold', '', '{}', 'reactions/reaction-bubble-overlay.psd',
  9.7, '1.0', false, true,
...
(
  ...
  'Reactions', 'Bold', '', '{}', 'reactions/community-vote-card.psd',
  11.4, '1.0', false, true,
...
(
  ...
  'Reactions', 'Dark', '', '{}', 'reactions/live-chat-reactions.psd',
  10.9, '1.0', false, true,
